...
from affordance.utils.transform import Transform
...
class TSDFVolume(object):
    ...
    def integrate(self, depth_img, fx, fy, extrinsic, img_width, img_height):
        """
        Args:
            depth_img: The depth image.
            intrinsic: The intrinsic parameters of a pinhole camera model.
