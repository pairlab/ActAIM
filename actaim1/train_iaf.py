from affordance.iafvae.model import IAFModel
...
def save_training_plot(x, y, name):
    ...
    training_plot_name = "IAF_" + name + "_train_plot.png"
...
def main(args):
    ...
    for epoch in range(total_epoch):
        ...
        for i, data in enumerate(train_loader):
            ...
            kl_loss_z, (recon_rotations, recon_point, recon_force) = model(inter_params, depth)
            ...
            loss_all = kl_loss_z + reconstruct_loss
            loss_all.backward()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--net", default="iafvae")
