...
class Trainer(BaseTrainer):
    ...
    def __init__(
        self, model, optimizer, device=None, input_type="pointcloud", vis_dir=None, threshold=0.5, eval_sample=False
    ):
        self.model = model
    ...
    def eval_step(self, data):
        ...
        if voxels_occ is not None:
            ...
            points_voxels = make_3d_grid((-0.5 + 1 / 64,) * 3, (0.5 - 1 / 64,) * 3, voxels_occ.shape[1:])
