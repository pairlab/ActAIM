...
def get_network(name):
    models = {
        ...
        "giga_aff_ipdf": GIGAipdf,
        "giga_aff_pair": GIGAAffPair,
        "giga_image": GIGAImage,
        "giga_score": GIGAScore,
        "giga_feature": GIGAFeature,
    }
...
def GIGAImage():
    config = {
        ...
        "decoder": "simple_local_image",
        "decoder_tsdf": False,
        "decoder_kwargs": {"dim": 2, "sample_mode": "bilinear", "hidden_size": 32, "concat_feat": True},
        "padding": 0,
        "c_dim": 32,
    }
    return get_model(config)
